...
print("Splitting test according to threshold...")
...
print("Writing the generated training- and test-set...")
...
print("Creating the folder of the training-set...")
...
print("Creating the folder of the test-set...")
i<- 1
...
print("Generating simplified version of the oracle...")
